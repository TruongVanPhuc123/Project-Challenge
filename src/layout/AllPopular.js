...
function AllPopular() {
    ...
    React.useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/movie/popular?page=${page}`, options)
            .then(response => {
        ...
        // console.log(`https://api.themoviedb.org/3/movie/popular?page=${page}`)
    }, [page])
    ...
    return (
        <>
            <Header />
            <div className='containerAllPopular'>
                <div className="containerMovie">
                    <div className='movie-title'>
                        <h2><span> All Popular</span></h2>
                    </div>
                    ...
                    <div className='btnActions-popular'>
