...
import '../css/AllNowPlaying.css'

function AllNowPlaying() {
    ...
    React.useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/movie/now_playing?page=${page}`, options)
            .then(response => {
    ...
    return (
        <>
            <Header />
            <div className='containerAllNowPlaying'>
                <div className="containerMovie">
                    <div className='movie-title'>
                        <h2><span> All Now Playing</span></h2>
                    </div>
                    ...
                    <div className='btnActions-nowPlaying'>
